...
If too many elements were hashed into the same key: looking inside this key may take O(n) time as you can see through my code as well.
...
It is very rare that many items will be hashed to the same key(if you choose a good hash function).
